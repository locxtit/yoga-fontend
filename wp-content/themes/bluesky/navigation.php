...
if ( is_single() ) {
   ...
   ?>
      <ul class="default-wp-page clearfix">
         <li class="previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'ample' ) . '</span> Trước' ); ?></li>
         <li class="next"><?php next_post_link( '%link', 'Sau <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'ample' ) . '</span>' ); ?></li>
      </ul>
   <?php
   }
}
