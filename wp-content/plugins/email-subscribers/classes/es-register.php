...
class es_widget_register extends WP_Widget 
{
	...
	function widget( $args, $instance ) 
	{
		...
		<div>
			...
			<div class="es_textbox">
				<input class="es_textbox_class" name="es_txt_email" placeholder="Nhập email ở đây..." id="es_txt_email" onkeypress="if(event.keyCode==13) es_submit_page('<?php echo $url; ?>')" value="" maxlength="225" type="text">
			</div>
			<div class="es_button">
				<input class="es_textbox_button" name="es_txt_button" id="es_txt_button" onClick="return es_submit_page('<?php echo $url; ?>')" value="<?php _e('Đăng kí', 'email-subscribers'); ?>" type="button">
			</div>
