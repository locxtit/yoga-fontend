	...
	if (http_req.readyState == 4) 
	{
		if (http_req.status == 200) 
		{
			...
			{ 
				...
				{
					alert('Đăng kí nhận bản tin thành công. Quí khách vui lòng xác nhận email. Cảm ơn Quí kháchđã quan tâm dịch vụ của Globalink');
					document.getElementById("es_msg_pg").innerHTML = "Subscribed successfully.";
					document.getElementById("es_txt_email_pg").value="";
				...
				{
					document.getElementById("es_msg_pg").innerHTML = "Email đã tồn tại.";
				}
				else if((http_req.responseText).trim() == "unexpected-error")
				{
					document.getElementById("es_msg_pg").innerHTML = "Rất tiếc .. xảy ra lỗi không mong muốn.";
				}
				else if((http_req.responseText).trim() == "invalid-email")
				{
					document.getElementById("es_msg_pg").innerHTML = "Email không hợp lệ.";
				}
				else
				{
